...
local DATA_PATH = 'assets/data/UX/FRC_UX_ArtCenter_Textures.json';
...
TextureSelector.new = function(scene, width, height)
	...
	local textures = data.readJSON(DATA_PATH).textures;
	...
	for i=1,#textures do
		...
		button._texturePath = 'assets/images/UX/FRC_UX_ArtCenter_Texture_' .. textures[i].id .. '.jpg';
